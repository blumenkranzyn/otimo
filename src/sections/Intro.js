                    ...
                    <div class="anim">
                        ...
                        <div>
                            ...
                            <defs>
                                ...
                                <stop offset="15%" stop-color="rgba(0,124,161,1)" />
                                <stop offset="75%" stop-color="rgba(0,124,161,0.3)" />
                                </linearGradient>
                            </defs>
                                ...
                                <g>
                                    <defs>
                                        <linearGradient id="MyGradient1"  gradientTransform="rotate(-10)">
                                            <stop offset="75%" stop-color="rgba(24,93,122,1)" />
                                            <stop offset="95%" stop-color="rgba(24,93,122,0.3)" />
                                        </linearGradient>
                                    </defs>
